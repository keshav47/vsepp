...
def from_flickr_json(path):
    with open('/home/ubuntu/filestore/keshav/vsepp/data/fashion/dataset_fashion.json') as json_file:
...
def main(data_path, data_name):
    ...
    with open('/home/ubuntu/filestore/keshav/vsepp/data/fashion/fashion_vocab.pkl', 'wb') as f:
