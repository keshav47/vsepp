...
def from_flickr_json(path):
    ...
    with open('/home/jupyter/filestore/product_matching/data/vsepp_data/training_vsepp_name_only.json') as json_file:
...
def main(data_path, data_name):
    ...
    with open('/home/jupyter/filestore/product_matching/data/vsepp_data/training_vsepp_vocab_name_only.pickle', 'wb') as f:
