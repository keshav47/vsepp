...
def from_flickr_json(path):
    ...
    with open('/home/jupyter/filestore/product_matching/data/vsepp_data/validation_vsepp.json') as json_file:
...
def main(data_path, data_name):
    ...
    with open('/home/jupyter/filestore/product_matching/data/vsepp_data/validation_vsepp_vocab.pickle', 'wb') as f:
